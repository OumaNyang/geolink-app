class ApplicationController < Sinatra::Base
  ...
  get "/" do
    { message: "Welcome to my phase 3 Ruby Project!" }.to_json
  end
  # Post county
  post '/counties' do
  ...
  get "/constituencies" do
   ...
   get "/county-constituencies/:county_code" do
    constituencies = Constituency.where('county_code=?',params[:county_code])
    constituencies.to_json
  end


    #  # get constituencies by county code
    #    get "/counties/constituencies/:county_code" do
    #     constituency = Constituency.find(params[:county_code])
    #     constituency.to_json
    # end
  # get constituency by code
end

# htpps://localhost:3000/county/constituencies/003
